    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center px-6">
      ...
      <div className="ml-auto flex items-center space-x-4">
        <button
          ...
          className={`p-1.5 rounded-md hover:bg-gray-100 ${isRecording ? 'recording' : 'text-gray-500'
            }`}
          title="Начать запись"
        >
        ...
        <button
          ...
          className={`p-1.5 rounded-md hover:bg-gray-100 ${isPaused ? 'paused' : 'text-gray-500'
            }`}
